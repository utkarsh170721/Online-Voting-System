...
public void LoginFrames(){
    ...
    rp=new JLabel("Organiation");
        ...
        rn1=new JLabel("Ramandeep Singh");
        rn1.setBounds(20, 250, 100, 20);
        rsp1.add(rn1);
        rp1=new JLabel("Local Public Party");
        ...
        rn2=new JLabel("Utkarsh Sharma");
        rn2.setBounds(20, 300, 100, 20);
        rsp1.add(rn2);
        rp2=new JLabel("Akhand Bharat Party");
        rp2.setBounds(180, 300, 100, 20);
        rsp1.add(rp2);
        rs2=new JButton("Red-Flag");
        ...
        rn3=new JLabel("Swatika");
        rn3.setBounds(20, 350, 100, 20);
         rsp1.add(rn3);
        rp3=new JLabel("Uttarakhand leader party");
        rp3.setBounds(180, 350, 100, 20);
        rsp1.add(rp3);
        rs3=new JButton("Lion");
   ...
   public void  Results(){
       ...
       lfp3.add(rrs);
        ...
        rrn1=new JLabel("Ramandeep Singh");
        rrn1.setBounds(30, 50, 100, 20);
        lfp1.add(rrn1);
        rrp1=new JLabel("Local Public Party");
        ...
        rrn2=new JLabel("Utkarsh Sharma");
        rrn2.setBounds(200, 50, 100, 20);
        lfp1.add(rrn2);
        rrp2=new JLabel("Akhand Bharat Party");
        rrp2.setBounds(200, 100, 100, 20);
        lfp1.add(rrp2);
        rrs2=new JButton("Red-Flag");
        ...
        rrn3=new JLabel("Swatika");
        rrn3.setBounds(320, 50, 100, 20);
        lfp1.add(rrn3);
        rrp3=new JLabel("Uttarakhand Leader Party");
        rrp3.setBounds(320, 100, 100, 20);
        lfp1.add(rrp3);
        rrs3=new JButton("Lion");
