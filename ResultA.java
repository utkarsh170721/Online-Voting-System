...
public class ResultA implements ActionListener  {
    ...
    jl8.setText("* Enter only Numeric Keys(0-9)");        }
     ...
     lop1.add(jp);
     String str[]={"--Select-City--","Dehradun","Haldwani","Kashipur","Haridwar","Almora","Kotdwar","Mussoorie","Khatima"};
     jl5=new JLabel("CITY:");
     ...
     lop1.add(jt2);
     String str1[]={"--Select-Province--","Uttrakashi","Chamoli","Pauri","Tehri","Dehradun"};
